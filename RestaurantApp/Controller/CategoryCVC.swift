...
private let reuseIdentifier = CellID.categoryCell
...
//        self.collectionView!.register(UICollectionViewCell.self, forCellWithReuseIdentifier: reuseIdentifier)
    ...
    override func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
		...
		let categoriesArray = responseData?.menu.categories
		
	return categoriesArray?.count ?? 3
    }

    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
		
		let drillData = responseData?.menu
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath) as! CategoryCVCCell
		cell.setName(with: drillData!, indexPath: indexPath)
        // Configure the cell
